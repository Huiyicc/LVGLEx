...
void WidgetBase::init() {
  if (m_obj) {
    WidgetEventBase::init(m_obj);
  }
}

lv_obj_t *WidgetBase::get_obj() const { return m_obj; };
...
void WidgetBase::set_x(const int32_t x) const { lv_obj_set_x(m_obj, x); }

void WidgetBase::set_y(const int32_t y) const { lv_obj_set_y(m_obj, y); }
...
void WidgetBase::move_foreground() const { lv_obj_move_foreground(m_obj); };
...
void WidgetBase::class_init_obj() const { lv_obj_class_init_obj(m_obj); }
...
void WidgetBase::update_layout() const { lv_obj_update_layout(m_obj); }
...
void WidgetBase::center() const { lv_obj_center(m_obj); }

void WidgetBase::set_transform(const lv_matrix_t *matrix) const {
  lv_obj_set_transform(m_obj, matrix);
}

void WidgetBase::reset_transform() const { lv_obj_reset_transform(m_obj); }
...
void WidgetBase::refr_pos() const { lv_obj_refr_pos(m_obj); }
...
void WidgetBase::invalidate() const { lv_obj_invalidate(m_obj); }
...
void WidgetBase::remove_style_all() const { lv_obj_remove_style_all(m_obj); }
...
void WidgetBase::delete_async() const { lv_obj_delete_async(m_obj); }

void WidgetBase::set_parent(lv_obj_t *parent) const {
  lv_obj_set_parent(m_obj, parent);
}

void WidgetBase::swap(lv_obj_t *obj2) const { lv_obj_swap(m_obj, obj2); }
...
void WidgetBase::dump_tree() const { lv_obj_dump_tree(m_obj); }
...
void WidgetBase::update_layer_type() const { lv_obj_update_layer_type(m_obj); }
